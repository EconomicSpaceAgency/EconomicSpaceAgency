...
The possibilities introduced by self-issuance enable economic spaces to rewrite the economic playbook according to new rules and new behavioural patterns. This translates in the possibility for [[#self-governance]].
...
On [[#Space]], tokens are not hardwired according to the functioning of the platform software, but rather can be programmed to correspond to the needs of the issues (an economic space) of the token; a token is just another kind of smart contract that is public to its users.

## W

### World Computing Fabric

see [[#Computing fabric]]
